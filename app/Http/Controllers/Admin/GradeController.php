    ...
    public function store(Request $request)
{
    ...
    AuditLog::create([
        ...
        'model_name' => 'Grade',
        'model_id' => $grade->id,
        'description' => 'A new grade was created: ' . $grade->title,
    ]);
    ...
    public function update(Request $request, Grade $grade)
{
    ...
    AuditLog::create([
        ...
        'model_name' => 'Grade',
        'model_id' => $grade->id,
        'description' => 'Grade updated. Changes: ' . json_encode($original),
    ]);
    ...
    public function destroy(Grade $grade)
{
    ...
    AuditLog::create([
        ...
        'model_name' => 'Grade',
        'model_id' => $grade->id,
        'description' => 'Grade deleted: ' . $grade->title,
    ]);
